void addFinally(World & w, Point pos){ // Finaly add the snake's body to the structure
...
void addBody(World & w){ // Find space around the last body part and ass the body part using addFinally
...
void snakeEat(World & w, Population & pop, bool & rainbow){ // Test to know if the snake eats the insects or the star
...
void updateBody(World & w){ // Udate the position of the body after the head has moved
